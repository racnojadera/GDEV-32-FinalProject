...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(windowWidth, windowHeight, "GDEV 30 Final Project", nullptr, nullptr);
	if (window == nullptr)
	{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		modelMatrix2 = glm::rotate(modelMatrix2, glm::radians(angleX), glm::vec3(1.0f, 0.0f, 0.0f));
		modelMatrix2 = glm::rotate(modelMatrix2, glm::radians(angleZ), glm::vec3(0.0f, 0.0f, 1.0f));
